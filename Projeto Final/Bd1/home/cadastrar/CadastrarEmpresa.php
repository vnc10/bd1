...
?>
        ...
        <h1 style="font-family: sans-serif; font-weight: bold; color: dimgray; padding-left: 380px;">Cadastrar Empresa</h1>
            <form action="..\insert\insertEmpresa.php" method="post">
            <div class="container">
              <div style="padding-left: 100px" class="col-6">
                ...
                <div class="form-group">
                  ...
                  <input type="number" required="" class="form-control" name="cnpj">
                </div>
                <div class="form-group">
