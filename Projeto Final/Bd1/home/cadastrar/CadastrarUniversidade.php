...
?>
        ...
        <h1 style="font-family: sans-serif; font-weight: bold; color: dimgray; padding-left: 380px;">Cadastrar Universidade</h1>
            <form action="..\insert\insertUniversidade.php" method="post">
            <div class="container">
