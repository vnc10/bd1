...
?>
        ...
        <h1 style="font-family: sans-serif; font-weight: bold; color: dimgray; padding-left: 380px;">Editar Empresa</h1>
            <form action="..\update\UpdateEmpresa.php" method="post">
            <div class="container">
              <div style="padding-left: 100px" class="col-6">
                <div class="form-group">
  					           <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputEmpresa"></label>
  					           <input type="hidden" class="form-control" name="idEmpresa" value="<?php echo $dadosEmpresa[0]; ?>">
  				     </div>
                <div class="form-group">
                  <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputNome">Nome</label>
                  <input type="text" required="" class="form-control" name="Nome" value="<?php echo $dadosEmpresa[1]; ?>">
                </div>
                <div class="form-group">
                  <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputCNPJ">CNPJ</label>
                  <input type="number" required="" class="form-control" name="cnpj" value="<?php echo $dadosEmpresa[2]; ?>">
                </div>
                <div class="form-group">
                  <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputDescricao">Descrição</label>
                  <input type="text" required="" class="form-control" name="Descricao" value="<?php echo $dadosEmpresa[3]; ?>">
                </div>
                <div class="form-group">
