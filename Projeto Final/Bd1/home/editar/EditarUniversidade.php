...
?>
        ...
        <h1 style="font-family: sans-serif; font-weight: bold; color: dimgray; padding-left: 380px;">Editar Universidade</h1>
            <form action="..\update\UpdateUniversidade.php" method="post">
            <div class="container">
              <div style="padding-left: 100px" class="col-6">
                <div class="form-group">
  					       <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputUniversidade"></label>
  					       <input type="hidden" class="form-control" name="idUniversidade" value="<?php echo $dadosUniversidade[0]; ?>">
  				     </div>
                <div class="form-group">
                  <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputNome">Nome</label>
                  <input type="text" required="" class="form-control" name="Nome" value="<?php echo $dadosUniversidade[1]; ?>">
                </div>
                <div class="form-group">
                  <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputTelefone">Telefone</label>
                  <input type="number" required="" class="form-control" name="Telefone" value="<?php echo $dadosUniversidade[2]; ?>">
                </div>
                <div class="form-group">
