...
?>
        ...
        <h1 style="font-family: sans-serif; font-weight: bold; color: dimgray; padding-left: 380px;">Editar Vaga</h1>
            <form action="..\update\UpdateVaga.php" method="post">
            <div class="container">
              <div style="padding-left: 100px" class="col-6">
                <div class="form-group">
  					           <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputVaga"></label>
  					           <input type="hidden" class="form-control" name="idVaga" value="<?php echo $dadosVaga[0]; ?>">
  				     </div>
                <div class="form-group">
                  <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputQuantidade">Quantidade</label>
                  <input type="number" required="" class="form-control" name="Quantidade" value="<?php echo $dadosVaga[1]; ?>">
                </div>
                <div class="form-group">
                  <label style="color: dimgray; font-family: sans-serif; font-size: large; font-weight: bold;" for="inputNome">Nome</label>
                  <input type="text" required="" class="form-control" name="Nome" value="<?php echo $dadosVaga[2]; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" required="" class="form-control" name="Habilidades" value="<?php echo $dadosVaga[4]; ?>">
                </div>
                <div class="form-group">
