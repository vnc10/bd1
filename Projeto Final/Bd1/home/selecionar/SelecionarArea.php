...
?>
        ...
        <h1 style="font-family: sans-serif; font-weight: bold; color: dimgray; padding-left: 380px;">Selecionar Area</h1>
            <div class="container">
              <div style="padding-left: 100px" class="col-6">
                  <form action="..\excluir\ExcluirArea.php" method="post">
                                  <div id="opcao">
