...
<head>
  ...
  <title>Selecionar Candidato</title>
  <!-- plugins:css -->
...
?>
        ...
        <h1 style="font-family: sans-serif; font-weight: bold; color: dimgray; padding-left: 380px;">Selecionar Candidato</h1>
            <div class="container">
              <div style="padding-left: 100px" class="col-6">
                  <form action="..\excluir\ExcluirCandidato.php" method="post">
                                  <div id="opcao">
                                  <select class="form-control" name="candidato" required="">
                                          ...
                                          <?php
                                              ...
                                              <option value ="<?php echo $dados ['idCandidato']; ?>"><?php echo $dados ['Nome']; ?>
                                              </option> <?php
                                              }
                                          ?>
                                          </select>
